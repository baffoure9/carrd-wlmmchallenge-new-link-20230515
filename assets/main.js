...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style4', { style: 'zoom-in', speed: 750, intensity: 4, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('.image.style3', { style: 'zoom-in', speed: 750, intensity: 4, delay: 0, staggerOrder: '', replay: false });
